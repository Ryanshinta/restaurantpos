...
<div class="container">
    <div class="upper-section">
        ...
        <form id="reservation-form" method="POST" action="{{ url('reservation/addTable') }}">
            {!! csrf_field() !!}
            <h2>Select Table</h2>
            <div id="table-list">
                <p>Please select {{ $n }} tables for :<input type="text" name="reserveId" value="{{ $r }}" readonly="true"> </p><br>
